...
<!--=====================================
			...
			<div id="cabezote" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
				...
				<div id="time" class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
					...
					<div class="text-center"><?php echo date(DATE_RFC2822); ?></div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
					...
					<p id="member"><?php echo "El Usuario actual es {$_SESSION["usuario"]} - hola";?> <span class="fa fa-chevron-down"></span>
						<br>
						<ol id="admin">
							...
							<li><a href="logout"><span class="fa fa-times"></span>Salir</a></li>
						</ol>
